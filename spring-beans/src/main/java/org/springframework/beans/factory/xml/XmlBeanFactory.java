...
/**
 * 对 {@link DefaultListableBeanFactory} 进行了扩展，主要用于从XML文档中读取 BeanDefinition
 * 对于注册及获取bean都是使用从父类{@link DefaultListableBeanFactory}继承的方法去实现,
 * 而唯独与父类不同的个性化实现就是增加了 {@link XmlBeanDefinitionReader} 类型的reader属性
 *
